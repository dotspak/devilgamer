...
var _loading_screen_scene:PackedScene = preload("res://scenes/loadingScreen.tscn")	## reference to loading screen PackedScene
...
func _add_loading_screen(transition_type:String="fade_to_black"):
	...
	#GameManager.get_game_screen().uiLayer.add_child(_loading_screen)
